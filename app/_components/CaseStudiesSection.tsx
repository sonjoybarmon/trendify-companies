  ...
  return (
    <div className="py-16 px-8 bg-white">
      <div className="text-center">
        <FCHeader title="Case Studies & Success Stories" subtitle="" />
...
export const caseStudies = [
  {
    ...
    color: "#000",
    description:
      "How Mindvalley became one of the Biggest Self-Help TikTok Pages Ever",
    // image: "/product5.png",
    image: "/Simplification.svg",
    info: {
      spotlight: [
        "Mindvalley, a global leader in the self-development space, thrives on offering transformative courses and events that nurture personal growth worldwide. With a mission to ignite positive change, Mindvalley wanted to leverage short-form platforms like TikTok to reach a broader audience.",
      ],
      challenge: [
        "Despite being a global leader in the self-development domain, Mindvalley had the challenge to magnify its organic presence on TikTok, in order to create a larger community and boost viewer engagement. The challenge resided in producing Tiktok aligned captivating content that resonated seamlessly with their target audience while staying true to their mission and core values.",
      ],
      solution: [
        "We partnered with Mindvalley to meet the challenge. We utilized our expertise in TikTok’s short-form format to craft native scripts, adapt existing content, and blend it with trending formats on TikTok. The collaboration focused on striking a balance between staying authentic to Mindvalley's mission and embracing the dynamic nature of short-form content.",
        "Our innovative approach included showcasing Mindvalley's life-changing courses and events in a format tailored to the TikTok platform, maximizing viewer engagement and retention.",
      ],
      outcome: [
        "The collaboration yielded remarkable results for Mindvalley. Within a short period, Mindvalley saw a 30% increase in organic followers on TikTok and an astounding 120% increase in overall engagement on their videos. The partnership with Trendify not only expanded Mindvalley's reach but also demonstrated the power of modern content strategies and the importance of embracing change.",
        "The campaign was a success, as evidenced by the growth in followers, engagement, and positive sentiment in the comments section of their TikTok videos.",
      ],
    },
  },
  {
